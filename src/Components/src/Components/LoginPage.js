...
export default function LoginPage({ onLogin }) {
  ...
  const handleSubmit = (e) => {
    ...
    if (schoolName.toLowerCase() === "bbhsoba" && password === "12345") {
      onLogin();
    } else setError("Invalid School Name or Password");
  };
      ...
      <div className="w-full max-w-3xl bg-white rounded-lg shadow-xl overflow-hidden">
        <div className="grid md:grid-cols-2 gap-0 flex-col-reverse md:flex-none">
          <div className="p-4 md:p-6 bg-gray-50 flex flex-col justify-center">
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 mb-4 rounded-r text-xs">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white py-3 rounded-lg font-bold text-xs uppercase tracking-wider transition duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
              >
